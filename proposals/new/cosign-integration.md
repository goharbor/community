...
Accessory: An extra stuff which can be added to an artifact in order to make it more versatile. In this proposal, the signature that generated by cosign can be seen as an accessory.

...
5.  Do not support verify signature in Harbor side(because of item #1, Harbor cannot verify the signatures without public keys).
...
1. Remove all the accessories that associated with artifact.
2. Remove the artifact itself.
...
#### Immutable [Multiple Signatures Discuss]

- If any artifact configured as immutable, all the accessories are immutable.

#### Garbage Collection [Multiple Signatures Discuss]
...
- You can scan an artifact and its signature.
